...
/**
 * Encrypts data using the SM4-ECB algorithm.
 *
 ...
 */
function encryptSM4ECB(data, password, extra = null) {
...
/**
 * Decrypts data using the SM4-ECB algorithm.
 *
 ...
 */
function decryptSM4ECB(encryptedData, password, extra = null) {
...
module.exports = { encryptSM4ECB, decryptSM4ECB };
