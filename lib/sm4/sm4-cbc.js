...
/**
 * Encrypts data using the SM4-CBC algorithm.
 *
 ...
 */
function encryptSM4CBC(data, password, extra = null) {
...
/**
 * Decrypts data using the SM4-CBC algorithm.
 *
 ...
 */
function decryptSM4CBC(encryptedData, password, extra = null) {
...
module.exports = { encryptSM4CBC, decryptSM4CBC };
