...
function encryptAES256CBC(data, password, extra = null) {
 ...
 */
function decryptAES256CBC(encryptedData, password, extra = null) {
...
module.exports = { encryptAES256CBC, decryptAES256CBC };
