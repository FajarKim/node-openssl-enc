...
/**
 * Encrypts data using the AES-256-CFB algorithm.
 *
...
function encryptAES256CFB(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-256-CFB algorithm.
 *
 ...
 */
function decryptAES256CFB(encryptedData, password, extra = null) {
...
module.exports = { encryptAES256CFB, decryptAES256CFB };
