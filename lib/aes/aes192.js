...
/**
 * Encrypts data using the AES192 algorithm.
 *
...
function encryptAES192(data, password, extra = null) {
...
/**
 * Decrypts data using the AES192 algorithm.
 *
 ...
 */
function decryptAES192(encryptedData, password, extra = null) {
...
module.exports = { encryptAES192, decryptAES192 };
