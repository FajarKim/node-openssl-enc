 ...
 */
function encryptAES256GCM(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-256-GCM algorithm.
 *
 ...
 */
function decryptAES256GCM(encryptedData, password, extra = null) {
