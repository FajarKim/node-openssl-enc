...
/**
 * Encrypts data using the AES-128-ECB algorithm.
 *
...
function encryptAES128ECB(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-128-ECB algorithm.
 *
 ...
 */
function decryptAES128ECB(encryptedData, password, extra = null) {
...
module.exports = { encryptAES128ECB, decryptAES128ECB };
