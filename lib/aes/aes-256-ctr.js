...
/**
 * Encrypts data using the AES-256-CTR algorithm.
 *
...
function encryptAES256CTR(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-256-CTR algorithm.
 *
 ...
 */
function decryptAES256CTR(encryptedData, password, extra = null) {
...
module.exports = { encryptAES256CTR, decryptAES256CTR };
