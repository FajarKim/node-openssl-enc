...
/**
 * Encrypts data using the AES-256-ECB algorithm.
 *
 ...
 */
function encryptAES256ECB(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-256-ECB algorithm.
 *
 ...
 */
function decryptAES256ECB(encryptedData, password, extra = null) {
