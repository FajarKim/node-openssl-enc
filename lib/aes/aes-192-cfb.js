...
/**
 * Encrypts data using the AES-192-CFB algorithm.
 *
 ...
 */
function encryptAES192CFB(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-192-CFB algorithm.
 *
 ...
 */
function decryptAES192CFB(encryptedData, password, extra = null) {
...
module.exports = { encryptAES192CFB, decryptAES192CFB };
