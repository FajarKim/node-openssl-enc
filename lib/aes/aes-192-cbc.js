...
/**
 * Encrypts data using the AES-192-CBC algorithm.
 *
 ...
 */
function encryptAES192CBC(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-192-CBC algorithm.
 *
 ...
 */
function decryptAES192CBC(encryptedData, password, extra = null) {
...
module.exports = { encryptAES192CBC, decryptAES192CBC };
