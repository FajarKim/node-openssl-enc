...
/**
 * Encrypts data using the AES-128-CTR algorithm.
 *
 ...
 */
function encryptAES128CTR(data, password, extra = null) {
 ...
 */
function decryptAES128CTR(encryptedData, password, extra = null) {
...
module.exports = { encryptAES128CTR, decryptAES128CTR };
