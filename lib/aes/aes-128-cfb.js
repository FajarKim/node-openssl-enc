...
/**
 * Encrypts data using the AES-128-CFB algorithm.
 *
...
function encryptAES128CFB(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-128-CFB algorithm.
 *
 ...
 */
function decryptAES128CFB(encryptedData, password, extra = null) {
...
module.exports = { encryptAES128CFB, decryptAES128CFB };
