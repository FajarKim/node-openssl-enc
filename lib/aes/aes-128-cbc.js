...
/**
 * Encrypts data using the AES-128-CBC algorithm.
 *
 ...
 */
function encryptAES128CBC(data, password, extra = null) {
 ...
 */
function decryptAES128CBC(encryptedData, password, extra = null) {
...
module.exports = { encryptAES128CBC, decryptAES128CBC };
