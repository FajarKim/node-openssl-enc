...
/**
 * Encrypts data using the AES-256-CFB8 algorithm.
 *
...
function encryptAES256CFB8(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-256-CFB8 algorithm.
 *
 ...
 */
function decryptAES256CFB8(encryptedData, password, extra = null) {
...
module.exports = { encryptAES256CFB8, decryptAES256CFB8 };
