...
/**
 * Encrypts data using the AES-128-OFB algorithm.
 *
...
function encryptAES128OFB(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-128-OFB algorithm.
 *
 ...
 */
function decryptAES128OFB(encryptedData, password, extra = null) {
...
module.exports = { encryptAES128OFB, decryptAES128OFB };
