...
/**
 * Encrypts data using the AES-192-CTR algorithm.
 *
...
function encryptAES192CTR(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-192-CTR algorithm.
 *
 ...
 */
function decryptAES192CTR(encryptedData, password, extra = null) {
...
module.exports = { encryptAES192CTR, decryptAES192CTR };
