...
/**
 * Encrypts data using the AES-256-OFB algorithm.
 *
...
function encryptAES256OFB(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-256-OFB algorithm.
 *
 ...
 */
function decryptAES256OFB(encryptedData, password, extra = null) {
...
module.exports = { encryptAES256OFB, decryptAES256OFB };
