...
/**
 * Encrypts data using the AES-256-CFB1 algorithm.
 *
...
function encryptAES256CFB1(data, password, extra = null) {
...
/**
 * Decrypts data using the AES-256-CFB1 algorithm.
 *
 ...
 */
function decryptAES256CFB1(encryptedData, password, extra = null) {
...
module.exports = { encryptAES256CFB1, decryptAES256CFB1 };
