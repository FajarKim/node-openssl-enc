...
/**
 * Encrypts data using the CAMELLIA-256-CFB algorithm.
 *
...
function encryptCAMELLIA256CFB(data, password, extra = null) {
...
/**
 * Decrypts data using the CAMELLIA-256-CFB algorithm.
 *
 ...
 */
function decryptCAMELLIA256CFB(encryptedData, password, extra = null) {
...
module.exports = { encryptCAMELLIA256CFB, decryptCAMELLIA256CFB };
