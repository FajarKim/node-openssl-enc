...
/**
 * Encrypts data using the CAMELLIA-128-CBC algorithm.
 *
...
function encryptCAMELLIA128CBC(data, password, extra = null) {
...
/**
 * Decrypts data using the CAMELLIA-128-CBC algorithm.
 *
 ...
 */
function decryptCAMELLIA128CBC(encryptedData, password, extra = null) {
...
module.exports = { encryptCAMELLIA128CBC, decryptCAMELLIA128CBC };
