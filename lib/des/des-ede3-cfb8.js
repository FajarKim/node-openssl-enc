...
/**
 * Encrypts data using the DES-EDE3-CFB8 algorithm.
 *
...
function encryptDESEDE3CFB8(data, password, extra = null) {
...
/**
 * Decrypts data using the DES-EDE3-CFB8 algorithm.
 *
 ...
 */
function decryptDESEDE3CFB8(encryptedData, password, extra = null) {
...
module.exports = { encryptDESEDE3CFB8, decryptDESEDE3CFB8 };
