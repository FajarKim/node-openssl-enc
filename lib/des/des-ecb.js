...
/**
 * Encrypts data using the DES-ECB algorithm.
 *
 ...
 */
function encryptDESECB(data, password, extra = null) {
...
/**
 * Decrypts data using the DES-ECB algorithm.
 *
 ...
 */
function decryptDESECB(encryptedData, password, extra = null) {
...
module.exports = { encryptDESECB, decryptDESECB };
