...
/**
 * Encrypts data using the DES-EDE3-CBC algorithm.
 *
...
function encryptDESEDE3CBC(data, password, extra = null) {
...
/**
 * Decrypts data using the DES-EDE3-CBC algorithm.
 *
 ...
 */
function decryptDESEDE3CBC(encryptedData, password, extra = null) {
...
module.exports = { encryptDESEDE3CBC, decryptDESEDE3CBC };
