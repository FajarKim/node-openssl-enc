...
/**
 * Encrypts data using the DES-CBC algorithm.
 *
...
function encryptDESCBC(data, password, extra = null) {
...
/**
 * Decrypts data using the DES-CBC algorithm.
 *
 ...
 */
function decryptDESCBC(encryptedData, password, extra = null) {
...
module.exports = { encryptDESCBC, decryptDESCBC };
